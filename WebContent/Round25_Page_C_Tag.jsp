...
<body>
	...
	<%
		...
		<c:forTokens var="obj" items="${ delim_str }" delims="," varStatus="pos">
		 ...
		 <c:url value="http://localhost:8181/20220425_Round25/Round25_Page_ELView.jsp"/><br/>
		 <c:url value="/Round25_Page_ELView.jsp" context="/220425_Round25"/><br/>
		 <c:url value="http://localhost:8181/20220425_Round25/Round25_Page_ELView.jsp" var="elurl" scope="request"/><br/>
		 
		 <c:import url="${ requestScope.elurl }"/><br/><br/>
		 <hr/>
		 
		 <c:import url="http://localhost:8181/20220425_Round25/Round25_Page_ELView.jsp"/>
		 <c:import url="http://localhost:8181/20220425_Round25/Round25_Page_ELView.jsp" var="elview" scope="request"/>
		 <c:import url="/Round25_Page_ELView.jsp" context="/20220425_Round25" varReader="in">
		 ...
		 <%--    <c:redirect url="http://localhost:8181/20220425_Round25/Round25_Page_Input.jsp">
		    </c:redirect>
		  	 --%>
